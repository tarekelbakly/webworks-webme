...
function content_snippet_edit(ev){
	...
	$.getJSON('/ww.plugins/content-snippet/admin/widget-form.php',{'get_content_snippet':id},function(res){
		...
		ww.content_snippet.rte=CKEDITOR.replace( 'content_snippet_html'+ww.content_snippet.editor_instances,{filebrowserBrowseUrl:"/j/kfm/",menu:"WebME",scayt_autoStartup:false} );
