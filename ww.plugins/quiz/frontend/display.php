...
*/
	...
	/**
	  * Displays a line with the quiz name and description and a take quiz button
	  *
...
/**
  ...
  * It figures out if a list of quizzes, question or results should be displayed 
  * and displays the correct thing
  *
  * @see displayQuizInfo
