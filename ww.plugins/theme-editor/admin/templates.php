...
<script src="/ww.plugins/theme-editor/j/CodeMirror-0.67/js/codemirror.js">
</script>
<script type="text/javascript">
	var editor = CodeMirror.fromTextArea("theme-body", {
	  ...
	  path: "/ww.plugins/theme-editor/j/CodeMirror-0.67/js/",
		stylesheet: [
			"/ww.plugins/theme-editor/j/CodeMirror-0.67/css/xmlcolors.css",
			"/ww.plugins/theme-editor/j/CodeMirror-0.67/css/jscolors.css",
			"/ww.plugins/theme-editor/j/CodeMirror-0.67/css/csscolors.css"
		]
	});
</script>
