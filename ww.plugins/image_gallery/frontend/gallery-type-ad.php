...
for($i=0;$i<$n;$i++){
	$c.='<li> <a href="/kfmget/'.$images[$i]['id'].'"> <img src="/kfmget/'.$images[$i]['id'].',width='.$vars['image_gallery_thumbsize'].',height='.$vars['image_gallery_thumbsize'].'" title="'.$images[$i]['caption'].'"> </a> </li>';
}
$c.='</ul> </div> </div> </div>';
